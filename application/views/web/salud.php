...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <ul>
        <li>Paola Alejandra Ruiz</li>
      </ul> 
      <p>Auxiliar de Enfermeria</p>
      <ul>
        <li>Ary Campo</li>
        <li>Blanca Troyano</li>
        <li>Deisy Martinez</li>
        <li>Eduardo Arenas</li>
        <li>Jaime Ordoñez</li>
        <li>Katerine Benavidez</li>
        <li>Lorena Uribe</li>
        <li>Natalia Rivera</li>
        <li>Stiven Bastidas</li>
        <li>Yohana Medina</li>
      </ul>
      <p>Medicina General</p>
      <ul>
        <li>Luis Felipe Penagos</li>
        <li>Paola Andrea Ramirez</li>
      </ul>
      <p>Nutricionista</p>
      <ul>
        <li>Leidys Katherine Lopez</li>
      </ul>
      <p>Odontologia</p>
      <ul>
        <li>Linda Maite Muñoz</li>
      </ul>
      <p>Psiquiatra</p>
      <ul>
        <li>Claudia Guzman</li>
        <li>Juanita Muñoz</li>
      </ul>
      </div>
...
<h4>Valoración gestionada por el área de enfermería</h4><p>Desde el área de enfermería se inicia con el proceso
para ser valorado por los profesionales de la salud, medicina general, psiquiatría, odontología y nutrición, 
se procede a realizar la descripción del tratamiento médico a seguir y recomendaciones generales;
los datos personales se registran en el Kardex de enfermería, se realiza la respectiva nota de ingreso de 
enfermería y se realizan las tarjetas de medicamentos con sus respectivos tratamientos farmacológicos.
<ul>
    <li><a href="http://auxiliardeenfermeriapasoapaso.blogspot.com/2012/08/el-kardex-de-enfermeria.html" target="_blank"> Kardex de Enfermería</a></li>
    <li><a href="https://es.slideshare.net/gcarmenpromo/notas-de-enfermeria" target="_blank">Notas de enfermería</a></li>
