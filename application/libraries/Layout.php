...
/**
	 ...
	 * @var sting
	 */	
	public $title       = '| Fundación Salvando Sueños';	
    public $name       = 'Fundación Salvando Sueños';	
	public $keywords    = 'fundación, salvando,sueños, popayán, cauca';	
	public $descripcion = 'Fundación salvando sueños';
